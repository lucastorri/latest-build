...
module.exports = function(spec) {
  ...
  var fakeTalk = function(){
	var agilevale1 = new Talk();
	agilevale1.title = 'stub';
	agilevale1.start = new Date(2020, 8, 5, 9, 30, 0, 0);
	agilevale1.end = new Date(2020, 8, 5, 10, 20, 0, 0);
	return agilevale1;
   }
