...
module.exports = function(spec) {
  ...
  app.post('/conference', function(req, res){
    ...
    var talk = new Talk({title: 'temp workaround to get it working'});
  ...
  app.put('/conference/:id', function(req, res){
    ...
    var valid = conference.title.length > 0;
    if (!valid) return res.json({original: conference, errors: {title: 'you should input a title'}}, 400);
